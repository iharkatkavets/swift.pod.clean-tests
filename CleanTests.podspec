...
Pod::Spec.new do |s|
  s.name             = 'CleanTests'
  s.version          = '0.1.0'
  s.summary          = 'A short description of CleanTests.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Igor Kotkovets/CleanTests'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Igor Kotkovets' => 'igorkotkovets@users.noreply.github.com' }
  s.source           = { :git => 'https://github.com/Igor Kotkovets/CleanTests.git', :tag => s.version.to_s }
